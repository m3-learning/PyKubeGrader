...
def merge_bb_learn_data(bblearn_csv: str, grades_csv: str,
    ...
    try: bblearn_df = pd.read_csv(bblearn_csv)
    except: bblearn_df = pd.read_excel(bblearn_csv)
    try: grades_df = pd.read_csv(grades_csv)
    except: grades_df = pd.read_excel(grades_csv)
